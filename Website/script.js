...
window.onload = function () {
  ...
  var commandes = ["CV", "PROGRAMMES", "ACCUEIL", "LS", "HISTORY", "CLEAR", "HELP","TELECHARGER_CV"];
  var buffer = [];
  var history = [];
    ...
    if (res.includes(commande)) {
      ...
      switch (commande) {
        ...
        case commandes[6]:
          ...
          break;
        case commandes[7]:
            let cv_fich=window.open("",'');
            cv_fich.document.body.style.backgroundColor="black";
            for(let i=0;i<cv.length;i++){
              cv_fich.document.writeln(cv[i]+"</br>");
            }
